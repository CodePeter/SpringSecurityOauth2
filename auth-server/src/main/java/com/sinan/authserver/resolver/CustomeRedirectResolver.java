package com.sinan.authserver.resolver;
...
public class CustomeRedirectResolver implements RedirectResolver {
...
//        return antPathMatcher.matchStart(registeredPath, requestPath);
        boolean matched = antPathMatcher.match(requestPath, registeredPath);
        return matched;
//        return antPathMatcher.match(registeredPath, requestPath);
    }
